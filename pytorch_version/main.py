...
def bind_model(model):
    ...
    def infer(image_path):
        result = []
        with torch.no_grad():             
            batch_loader = DataLoader(dataset=PathDataset(image_path, labels=None), ## pytorch data loader 사용
...
if __name__ == '__main__':
    ...
    if config.mode == 'train': ### training mode 일때는 여기만 접근
        ...
        # Data loader
        batch_loader = DataLoader(dataset=PathDataset(image_path, labels, test_mode=False), ## pytorch data loader 사용
